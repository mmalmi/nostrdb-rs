...
pub type ndb_uid_t = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ndb_uid_map {
    pub env: *mut ::std::os::raw::c_void,
    pub str_to_id_db: *mut ::std::os::raw::c_void,
    pub id_to_str_db: *mut ::std::os::raw::c_void,
    pub next_id: u32,
}
#[test]
fn bindgen_test_layout_ndb_uid_map() {
    const UNINIT: ::std::mem::MaybeUninit<ndb_uid_map> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<ndb_uid_map>(),
        32usize,
        concat!("Size of: ", stringify!(ndb_uid_map))
    );
    assert_eq!(
        ::std::mem::align_of::<ndb_uid_map>(),
        8usize,
        concat!("Alignment of ", stringify!(ndb_uid_map))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(ndb_uid_map),
            "::",
            stringify!(env)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).str_to_id_db) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(ndb_uid_map),
            "::",
            stringify!(str_to_id_db)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).id_to_str_db) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(ndb_uid_map),
            "::",
            stringify!(id_to_str_db)
        )
    );
    assert_eq!(
...
extern "C" {
    ...
    pub fn ndb_uid_to_pubkey(
        ...
        map: *mut ndb_uid_map,
        uid: ndb_uid_t,
        pubkey_out: *mut ::std::os::raw::c_uchar,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Destroy UID map (closes databases)"]
    pub fn ndb_uid_map_destroy(map: *mut ndb_uid_map);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ndb_socialgraph {
    pub env: *mut ::std::os::raw::c_void,
    pub uid_map: ndb_uid_map,
    pub follow_distance_db: *mut ::std::os::raw::c_void,
...
#[test]
fn bindgen_test_layout_ndb_socialgraph() {
    const UNINIT: ::std::mem::MaybeUninit<ndb_socialgraph> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        ::std::mem::align_of::<ndb_socialgraph>(),
        8usize,
        concat!("Alignment of ", stringify!(ndb_socialgraph))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).env) as usize - ptr as usize },
        0usize,
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).uid_map) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(ndb_socialgraph),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).follow_distance_db) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(ndb_socialgraph),
            "::",
            stringify!(follow_distance_db)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).users_by_follow_distance_db) as usize - ptr as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(ndb_socialgraph),
            "::",
            stringify!(users_by_follow_distance_db)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).followed_by_user_db) as usize - ptr as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(ndb_socialgraph),
            "::",
            stringify!(followed_by_user_db)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).followers_by_user_db) as usize - ptr as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(ndb_socialgraph),
            "::",
            stringify!(followers_by_user_db)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        concat!(
            ...
            stringify!(ndb_socialgraph),
            "::",
            stringify!(follow_list_created_at_db)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        concat!(
            ...
            stringify!(ndb_socialgraph),
            "::",
            stringify!(mute_list_created_at_db)
        )
    );
    assert_eq!(
...
extern "C" {
    #[doc = " Handle a mute list event (kind 10000)\n Updates mute graph based on p-tags\n Must be called within a write transaction\n @param txn Active write transaction\n @param graph Social graph\n @param note The mute list note\n @return 1 on success, 0 on failure"]
    pub fn ndb_socialgraph_handle_mute_list(
        txn: *mut ::std::os::raw::c_void,
        graph: *mut ndb_socialgraph,
        note: *mut ndb_note,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    #[doc = " Get follow distance from root user (internal API)\n @param txn Active transaction\n @param graph Social graph\n @param pubkey 32-byte pubkey\n @return Distance (0 = root, 1 = followed by root, etc), 1000 if not in graph"]
    pub fn ndb_sg_get_follow_distance(
        txn: *mut ::std::os::raw::c_void,
        graph: *mut ndb_socialgraph,
        pubkey: *const ::std::os::raw::c_uchar,
    ) -> u32;
...
extern "C" {
    #[doc = " Check if one user follows another (internal API)\n @param txn Active transaction\n @param graph Social graph\n @param follower_pubkey 32-byte follower pubkey\n @param followed_pubkey 32-byte followed pubkey\n @return 1 if following, 0 otherwise"]
    pub fn ndb_sg_is_following(
        txn: *mut ::std::os::raw::c_void,
        graph: *mut ndb_socialgraph,
        follower_pubkey: *const ::std::os::raw::c_uchar,
        followed_pubkey: *const ::std::os::raw::c_uchar,
...
extern "C" {
    #[doc = " Get list of users followed by a user (internal API)\n @param txn Active transaction\n @param graph Social graph\n @param pubkey 32-byte pubkey\n @param followed_out Output array of 32-byte pubkeys (caller allocates)\n @param max_out Maximum number of entries in output array\n @return Number of followed users written to output (may be less than actual count)"]
    pub fn ndb_sg_get_followed(
        txn: *mut ::std::os::raw::c_void,
        graph: *mut ndb_socialgraph,
        pubkey: *const ::std::os::raw::c_uchar,
        followed_out: *mut ::std::os::raw::c_uchar,
...
extern "C" {
    #[doc = " Get list of followers of a user (internal API)\n @param txn Active transaction\n @param graph Social graph\n @param pubkey 32-byte pubkey\n @param followers_out Output array of 32-byte pubkeys (caller allocates)\n @param max_out Maximum number of entries in output array\n @return Number of followers written to output (may be less than actual count)"]
    pub fn ndb_sg_get_followers(
        txn: *mut ::std::os::raw::c_void,
        graph: *mut ndb_socialgraph,
        pubkey: *const ::std::os::raw::c_uchar,
        followers_out: *mut ::std::os::raw::c_uchar,
...
extern "C" {
    #[doc = " Get follower count for a user (internal API)\n @param txn Active transaction\n @param graph Social graph\n @param pubkey 32-byte pubkey\n @return Number of followers"]
    pub fn ndb_sg_follower_count(
        txn: *mut ::std::os::raw::c_void,
        graph: *mut ndb_socialgraph,
        pubkey: *const ::std::os::raw::c_uchar,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    #[doc = " Get list of users muted by a user (internal API)\n @param txn Active transaction\n @param graph Social graph\n @param pubkey 32-byte pubkey\n @param muted_out Output array of 32-byte pubkeys (caller allocates)\n @param max_out Maximum number of entries in output array\n @return Number of muted users written to output (may be less than actual count)"]
    pub fn ndb_sg_get_muted(
        txn: *mut ::std::os::raw::c_void,
        graph: *mut ndb_socialgraph,
        pubkey: *const ::std::os::raw::c_uchar,
        muted_out: *mut ::std::os::raw::c_uchar,
...
extern "C" {
    #[doc = " Get list of users who mute this user (internal API)\n @param txn Active transaction\n @param graph Social graph\n @param pubkey 32-byte pubkey\n @param muters_out Output array of 32-byte pubkeys (caller allocates)\n @param max_out Maximum number of entries in output array\n @return Number of muters written to output (may be less than actual count)"]
    pub fn ndb_sg_get_muters(
        txn: *mut ::std::os::raw::c_void,
        graph: *mut ndb_socialgraph,
        pubkey: *const ::std::os::raw::c_uchar,
        muters_out: *mut ::std::os::raw::c_uchar,
...
extern "C" {
    #[doc = " Recalculate follow distances from root user via BFS\n Must be called within a write transaction\n @param txn Active write transaction\n @param graph Social graph\n @return 1 on success, 0 on failure"]
    pub fn ndb_socialgraph_recalculate_distances(
        txn: *mut ::std::os::raw::c_void,
        graph: *mut ndb_socialgraph,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Destroy social graph (closes databases)"]
    pub fn ndb_socialgraph_destroy(graph: *mut ndb_socialgraph);
}
